 ...
 * camera service instance, for streaming or for image processing.
 * 
 ...
 * add this to the 'project' section of build.xml (modify it where noted):
 * 
 ...
 *     </manifest>
 *
 *     <!-- WARNING: remove the space from the 'includes' statement! -->
